...
function AddValue(id) {
  ...
  $("#items").append("<li id='Valueitem"+ id +"'> " + value + "[Done] " + "  </li>");
}
...
function AddValueToProgTask(id) {
  ...
  $("#progress_items").append("<li id='Progressitem"+ id +"'> " + value + "[Done] " + " </li>");
}
...
function AddValueToRemainingTask(id) {
  ...
  $("#add_remaining_task").append("<li id='Remainingitem"+ id +"'> " + value + "[Done] " + " </li>");
...
function AddValueToQueryTask(id) {
  ...
  $("#add_queries").append("<li id='Queryitem"+ id +"'> " + value + "[Done] " + " </li>");
...
function AddValueToNotesTask(id) {
  ...
  $("#add_notes").append("<li id='item"+ id +"'> " + value + "[Done] " + " </li>");
}
